...
/**
 * The closure hook returns a reference that updates, automatically, by dependencies passed to it.
 ...
 * import { useClosure } from '@weebu/react-hooks';
 *
 * export function Input() {
 *   const [clicks, setClicks] = useState(0);
 *   const [value, setValue] = useState('');
 *   const maxLengthRef = useClosure(() => maxLength, []);
 *
